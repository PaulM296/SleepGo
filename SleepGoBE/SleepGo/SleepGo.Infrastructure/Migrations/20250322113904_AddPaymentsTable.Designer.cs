...
namespace SleepGo.Infrastructure.Migrations
{
    ...
    [Migration("20250322113904_AddPaymentsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SleepGo.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SleepGo.Domain.Entities.Hotel", b =>
                {
                    b.HasOne("SleepGo.Domain.Entities.Image", "Image")
                        .WithOne()
                        .HasForeignKey("SleepGo.Domain.Entities.Hotel", "ImageId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SleepGo.Domain.Entities.AppUser", "AppUser")
                        .WithOne("Hotel")
                        .HasForeignKey("SleepGo.Domain.Entities.Hotel", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SleepGo.Domain.Entities.Payment", b =>
                {
                    b.HasOne("SleepGo.Domain.Entities.Reservation", "Reservation")
                        .WithOne("Payment")
                        .HasForeignKey("SleepGo.Domain.Entities.Payment", "ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
